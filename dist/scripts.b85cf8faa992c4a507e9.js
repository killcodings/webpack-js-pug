      ...
      if (evt.target === valueBtn) {
        if (navigator.clipboard) {
          ...
          return new Promise((res, rej) => {
            ...
            textArea.remove();
            console.log('Copied textarea'); // console.log(navigator.clipboard);
          });
        }
      }
    });
...
let isSection = document.querySelectorAll(".section-heading"); // let isHeadingSection = document.querySelectorAll(".section-heading > h2:first-child");
...
}); // const createElt = (text) => {
//     const parent = document.querySelector('body')
//     const child = document.createElement('h1')
//     child.className = "main__title"
//     child.textContent = text
//     parent.append(child)
//  }
//  createElt('Hello World!')
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html {\n  font-family: generalFont;\n}\n\nh1 {\n  color: darkcyan;\n}\n\n.container__subtitle {\n  color: darkslategray;\n  display: block;\n  height: 140px;\n  background: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n  display: flex;\n  justify-content: center;\n}\n\n.example-table {\n  display: flex;\n  flex-direction: column;\n}\n.example-table__header tr {\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-template-rows: 1fr;\n  grid-gap: 20px;\n  grid-gap: 20px;\n  gap: 20px;\n}\n.example-table__body {\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-template-rows: 1fr;\n  grid-gap: 20px;\n  gap: 20px;\n}\n.example-table__row {\n  padding: 20px;\n  background-color: rgba(255, 0, 0, 0.133);\n}\n.example-table__copy-content {\n  padding: 10px;\n  cursor: pointer;\n  background-color: greenyellow;\n  transition: 0.3s;\n}\n.example-table__copy-content:active {\n  background-color: #3dff2f;\n}\n\n.section-heading h2:first-child {\n  background-color: red !important;\n}\n\n.conteiner + h2 {\n  background-color: green;\n}\n\n@font-face {\n  font-family: generalFont;\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ") format(\"truetype\");\n}", "",{"version":3,"sources":["webpack://./src/styles/_global.scss","webpack://./src/styles/index.scss","webpack://./src/styles/_fonts.scss"],"names":[],"mappings":"AAGA;EACE,wBAAA;ACFF;;ADKA;EACE,eARa;ACMf;;ADKE;EACE,oBAXa;EAYb,cAAA;EACA,aAAA;EACA,mDAAA;EACA,aAAA;EACA,uBAAA;ACFJ;;ADMA;EACE,aAAA;EACA,sBAAA;ACHF;ADKI;EACE,aAAA;EACA,qCAAA;EACA,uBAAA;EACA,cAAA;EACA,cAAA;EAAA,SAAA;ACHN;ADME;EACE,aAAA;EACA,qCAAA;EACA,uBAAA;EACA,cAAA;EAAA,SAAA;ACJJ;ADME;EACE,aAAA;EACA,wCAAA;ACJJ;ADOI;EACE,aAAA;EACA,eAAA;EACA,6BAAA;EACA,gBAAA;ACLN;ADMM;EACE,yBAAA;ACJR;;ADUA;EACE,gCAAA;ACPF;;ADSA;EACE,uBAAA;ACNF;;ACtDA;EACE,wBAAA;EACA,+DAAA;ADyDF","sourcesContent":["$primaryColor: darkcyan;\n$secondaryColor: darkslategray;\n\nhtml {\n  font-family: generalFont;\n}\n\nh1 {\n  color: $primaryColor;\n}\n.container {\n  &__subtitle {\n    color: $secondaryColor;\n    display: block;\n    height: 140px;\n    background: url(\"../images/webpack.png\");\n    display: flex;\n    justify-content: center;\n  }\n}\n\n.example-table {\n  display: flex;\n  flex-direction: column;\n  &__header {\n    tr {\n      display: grid;\n      grid-template-columns: repeat(4, 1fr);\n      grid-template-rows: 1fr;\n      grid-gap: 20px;\n      gap: 20px;\n    }\n  }\n  &__body {\n    display: grid;\n    grid-template-columns: repeat(4, 1fr);\n    grid-template-rows: 1fr;\n    gap: 20px;\n  }\n  &__row {\n    padding: 20px;\n    background-color: rgba(255, 0, 0, 0.133);\n  }\n  &__copy {\n    &-content {\n      padding: 10px;\n      cursor: pointer;\n      background-color: greenyellow;\n      transition: 0.3s;\n      &:active {\n        background-color: rgb(61, 255, 47);\n      }\n    }\n  }\n}\n\n.section-heading h2:first-child {\n  background-color: red !important;\n}\n.conteiner + h2 {\n  background-color: green;\n}\n","html {\n  font-family: generalFont;\n}\n\nh1 {\n  color: darkcyan;\n}\n\n.container__subtitle {\n  color: darkslategray;\n  display: block;\n  height: 140px;\n  background: url(\"../images/webpack.png\");\n  display: flex;\n  justify-content: center;\n}\n\n.example-table {\n  display: flex;\n  flex-direction: column;\n}\n.example-table__header tr {\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-template-rows: 1fr;\n  grid-gap: 20px;\n  gap: 20px;\n}\n.example-table__body {\n  display: grid;\n  grid-template-columns: repeat(4, 1fr);\n  grid-template-rows: 1fr;\n  gap: 20px;\n}\n.example-table__row {\n  padding: 20px;\n  background-color: rgba(255, 0, 0, 0.133);\n}\n.example-table__copy-content {\n  padding: 10px;\n  cursor: pointer;\n  background-color: greenyellow;\n  transition: 0.3s;\n}\n.example-table__copy-content:active {\n  background-color: #3dff2f;\n}\n\n.section-heading h2:first-child {\n  background-color: red !important;\n}\n\n.conteiner + h2 {\n  background-color: green;\n}\n\n@font-face {\n  font-family: generalFont;\n  src: url(\"../fonts/Prompt-Regular.ttf\") format(\"truetype\");\n}","@font-face {\n  font-family: generalFont;\n  src: url(\"../fonts/Prompt-Regular.ttf\") format(\"truetype\"),\n}"],"sourceRoot":""}]);
// Exports
...
/******/ })()
;
//# sourceMappingURL=scripts.b85cf8faa992c4a507e9.js.map